...
class PaxosControllerOVS(object):
  ...
  def __init__(self,
    ...
    self.paxos_ports = {}
    self.wan_port = None
    self.log = core.getLogger("PaxosOVS-{} {}".format(self.name, self.mac))
  ...
  def on_client(self, event, message):
    ...
    v = message #PaxosMessage.unpack_client(message)
