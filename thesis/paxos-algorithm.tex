...
We have also incorporated \textit{multi-Paxos slots} \cite{renesse.paxos},
...
Note that we don't really need to keep track of the round number $n$ in our
simplified algorithms. This number is determined in \textit{phase one} of
Paxos, and will therefore be unchanging during phase two.
