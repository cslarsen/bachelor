...
non--Byzantine, classic crash Paxos in {\em phase two}, where we have
...
\item Extend OpenFlow and OpenVSwitch so we can transfer bytecode down to
...
thesis will therefore be a study of {\em feasibility}.
