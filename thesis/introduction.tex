...
For performance reasons, the interaction between the data and
control planes should be kept at a minimum.  Optimally, the
...
possible.
\todo{Kan egentlig komme litt
tidligere på sak om vår oppgave her, og heller flytte detaljer til
"Theory"--delen.}
