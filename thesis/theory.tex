...
\acf{SDN}\index{SDN} is all about building, deploying and managing networks
...
Since version 1.0 of the OpenFlow specification\index{OpenFlow!version 1.0} was
released in 2009 there have been several point releases and errata.  The
most recent one as of 2014 is 1.4\index{OpenFlow!version 1.4}
