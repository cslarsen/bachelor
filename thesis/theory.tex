...
planes.\todo{Mer om decoupling, kopier tekst fra annet sted som forklarer
  mer om det}
...
\todo{lag diagram som viser switch med
  dataplane og control plane og så openflow sin versjon, vis også secure
    tunnel til controller}
