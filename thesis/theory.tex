...
\begin{figure}
  ...
  \begin{subfigure}{0.45\textwidth}
    ...
    \begin{tikzpicture}[every node/.style={draw, circle},node distance=2.5cm]
      ...
      \node [draw=none] (S) at (0,0) {$\textbf{S}$};
  ...
  \begin{subfigure}{0.1\textwidth}
    % This figure is just for spacing between the two
    \centering
    \begin{tikzpicture}
    \end{tikzpicture}
  \end{subfigure}%
  \begin{subfigure}{0.45\textwidth}
    ...
    \end{tikzpicture}
    \caption{\acs{SDN} decouples the control plane $C$ from the forwarding
