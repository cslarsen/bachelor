...
you don't use this optio you can manually type \texttt{ssh -t} to request
TTYs correctly.}
...
Boot the VM and make sure you can log on to it without typing any password:
...
You can find the thesis source code on the Mininet VM under \texttt{~/bach}.
