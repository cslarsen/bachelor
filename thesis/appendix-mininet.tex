...
The author's settings in \textit{VirtualBox}\index{VirtualBox} for the Linux
VM\index{VM} are given in table \vref{table:vm.settings}.  The fields marked
...
then you should attempt to ssh\index{ssh} into it from a terminal on the host
computer.
