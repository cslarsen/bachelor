...
constituent element.
%
As a demonstration of its use, we have built a system where stateless
...
%
However, we learned that by moving primitive operations down to the switch,
it became much easier to build flows---compared to programming them in the
controller.
%
We therefore believe that in the coming time, \acs{SDN} will grow to
encompass programming on the switch.
