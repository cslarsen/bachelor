...
A trend in the computing industry is that more and more services are being
moved to the Cloud, reaching a larger number of users. Thus, it becomes even
more important that these services remain available despite failure of
individual machines running those services. This calls for replicating these
services on several machines. A huge body of research in the distributed
computing community have been devoted to coming up with protocols to
guarantee strong consistency among the replicas of such a service.
%
...
on the a software switch, making it possible for controllers to compose
