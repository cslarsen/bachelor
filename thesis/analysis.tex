...
All our network configurations use the L2 learning switch\index{switch!L2
...
\ref{figure:baseline.topology} and send ICMP ping\index{ping} packets from one end of
...
controllers.  The controllers implement L2 learning switches\index{switch!L2
learning} and will not install any flow table entries for rapid dispatch.
