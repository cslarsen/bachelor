...
Based on our design in \vref{chapter:design}, we will now look at how we can
implement our replication system.
...
\begin{table}[H]
  ...
  \begin{tabular}{l|l|c|c|c|}
    ...
    \hline
      \dots & \texttt{PAXOS JOIN}   & Node ID & MAC source &
        \multicolumn{1}{c}{} \\

    \hline
      \dots & \texttt{PAXOS CLIENT} &         &            &
        \multicolumn{1}{c}{Client packet} \\

    \hline
      \dots & \texttt{PAXOS ACCEPT} & Round no. & Sequence no. &
          Client packet \\

    \hline
      \dots & \texttt{PAXOS LEARN}  & Round no. & Sequence no.  &
          \multicolumn{1}{c}{} \\

    \cline{1-4}
  \end{tabular}

  \caption{The structure of Paxos messages.}
